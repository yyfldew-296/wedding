...
Page({
  data: {
    ...
    groomVow: '静静，我是一个写代码的人。不擅长说漂亮话，但我把我们的每一天都记得很精确——2024年10月4日18:12遇见你，2024年11月25日18:49爱上你。我在深圳加班到深夜的时候，想到你在等我，就觉得一切都值得。我没什么大本事，但我会用一辈子，写一段只属于我们的程序，它只有一个功能：让你每天都比昨天更幸福一点点。',
    brideVow: '亦富，谢谢你出现在我的生命里。你总说自己不浪漫，可你会记住我们相遇的每一分钟，会在加班后给我打视频，会默默存钱，计划着带我走遍全国。从今天起，你在哪，家就在哪。不管是深圳的出租屋，还是路上的SUV——有你的地方，就是我的家。',
    blessName: '',
    blessMsg: '',
    blessings: [],
    timer: null,
